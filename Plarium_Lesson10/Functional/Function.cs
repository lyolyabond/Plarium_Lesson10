...
namespace Plarium_Lesson10
{
    class Function
    {
        ...
        static void KeyMatchingForList(int key)
        {
        ...
        /// <param name="key"></param>
        /// <param name="flag"></param>
        static void KeyMatchingForDictionary(int key)
        {
            //Выборка единственного элемента словаря, с которым совпадает ключ
            ...
            try
            {
                ...
                //Проход по элементам выборки
                    ...
                    //Запись информации по ключу
                        KeyMatchingForList(keyValue.Key);
                        flag = true;
                     }
                if (!flag)
                    throw new Exception();
        ...
        public static void DisplayInformationByPrice()
        {
            ...
            try
            {
                ...
                foreach (Souvenir souvenir in Souvenirs)
                {
                    ...
                    {
                        //Запись информации по ключу
                        KeyMatchingForDictionary(souvenir.ManufacturerRequisites);
                        flag = true;
                    }
